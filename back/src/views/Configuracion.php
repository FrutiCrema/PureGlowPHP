...
$username = $_SESSION['AUTH']['user_userName'];

$fullname = $_SESSION['AUTH']['user_name'];
$email = $_SESSION['AUTH']['user_email'];
$image = $_SESSION['AUTH']['user_image'];
$gender = $_SESSION['AUTH']['user_gender'];
$password = $_SESSION['AUTH']['user_password'];
$birthdate = $_SESSION['AUTH']['user_birthDate'];
$rol = $_SESSION['AUTH']['user_rol'];
$idUser = $_SESSION['AUTH']['user_id'];


// echo "<script>";
// echo "var usernameOriginal = '" . $usernameOriginal . "';";
// echo "</script>";
...
<div id="configuracion">
    <br>
    <form id="formConfiguracion" action="#" method="POST" enctype="multipart/form-data">
        <div>
        ...
        <div>
            ...
            <input type="text" id="username" name="username" minlength="3" required value="<?php echo $username; ?>"><br>
        </div>
        <div>
        ...
        <div>
            ...
            <img id="avatar" src="<?php echo $image; ?>" alt="Foto de perfil" style="width: 150px; height: 150px;"><br>
            <input type="file" id="image" accept="image/*" name="image" required />
        </div>
        <div>
            <label for="fullname">Nombre Completo:</label>
            <input type="text" id="fullname" name="fullname" required value="<?php echo $fullname; ?>"><br>
        </div>
        <div>
            <label for="birthdate">Fecha de nacimiento:</label>
            <input type="date" id="birthdate" name="birthdate" required value="<?php echo $birthdate; ?>"><br>
        </div>
        <div>
            ...
            <select id="gender" name="gender" required>
                ...
                <option value="other" <?php if($gender == 'other') echo 'selected'; ?>>Otro</option>
            </select><br>
        </div>
        <div>
    ...
    <form action="#" id="formConfiguracion2">
    <button type="submit" onclick="eliminarPerfil(<?php echo $idUser; ?>)">Eliminar perfil</button>
...
<script src="/PureGlow/back/src/js/Configuracion.js"></script>
<script src="/PureGlow/back/src/js/EliminarPerfil.js"></script>
