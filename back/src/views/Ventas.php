...
<h2>Ventas</h2>
  <form id="consulta-ventas-form">
      ...
      <label for="consulta_detallada">¿Consulta detallada?</label>
    <input type="checkbox" id="consulta_detallada" name="consulta_detallada">

      <button type="button" onclick="consultarCompras()">Consultar</button>
...
<script src="/PureGlow/back/src/js/ventas.js"></script>
