...
$productos = $_SESSION["PRODUCTOS_MENSAJES"];
...
<body>
    ...
    if (!empty($productos)) {
            echo '<div class="product-center">';
                ...
                echo '<p class="name_product">' . $productos['producto_name'] . '</p>';
                echo '<img src="' . $productos['imagen_content'] . '" alt="Producto" class="product-image">';
                ...
                echo '<input type="hidden" class="product-id" value="' . $productos['conversacion_idProduct'] . '">';
                echo '</div>';
    ...
    <script src="/PureGlow/back/src/js/PuntuacionCotizacion.js"></script>
</body>
</html>
