...
<div class="perfil-container">
  <img id="perfil-img" src="<?php echo $image; ?>" alt="Foto de perfil" style="width: 300px; height: 250px;">
  <div class="perfil-info">
    <p><strong>Usuario:</strong> <span id="username"><?php echo $username; ?></span></p>
    <p><strong>Nombre:</strong> <span id="fullname"><?php echo $fullname; ?></span></p>
    <p><strong>Correo:</strong> <span id="email"><?php echo $email; ?></span></p>
  </div>
</div>
