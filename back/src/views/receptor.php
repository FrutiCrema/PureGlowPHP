...
$pdt_identity_token = 'v3gD8pMApEh6cznPiRME8TOfBPGe1uejamLz4Bs88ShGUQ6Wm1HrgeJmH1G';
...
$redirect_url = "$baseUrl/Puntuacion.php";

// Redirigir al usuario a la página de destino
header("Location: $redirect_url");
exit; // Asegúrate de terminar la ejecución del script después de enviar la cabecera de redirección
