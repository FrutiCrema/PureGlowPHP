...
<head>
  ...
  <!-- Custom StyleSheet -->
  <link rel="stylesheet" href="/PureGlow/front/styles/Mensajes.css">
...
<h2 id = "mensajes-titulo">Mensajes</h2>
  <div id="chat-container">
    ...
    <div>
      <div class="message-container" id="message-container">
        <!-- <div class="message bot-message">¡Hola! Soy un bot. ¿En qué puedo ayudarte?</div> -->
      </div>
...
<div>
  <div class="product-container" id="product-info">


  </div>

  <?php
  // Verificar si $rol es igual a 1
  if ($rol == 1) {
      // Si $rol es igual a 1, mostrar el botón "Aceptar"
      echo '
      <p>Precio</p>
      <input type="text" id="precio-input" placeholder="Precio..." disabled>
      <p>Especificaciones</p>
      <input type="text" id="especificaciones-input" placeholder="Escribe..." disabled>
      <button type="submit" id="accept-buttonn"  class="button button-disabled" onclick="aceptarCotizacion()">Aceptar</button>';
  } else {
      // Si $rol no es igual a 1, mostrar el botón "Enviar cotización"
      echo '
      <p>Precio</p>
      <input type="number" id="precio-input" placeholder="Precio...">
      <p>Especificaciones</p>
      <input type="text" id="especificaciones-input" placeholder="Escribe..." >
      <button type="submit" id="accept-buttonn"  class="button button-enabled" onclick="sendQuotation()">Enviar cotización</button>';
  }
  ?>      
</div>
...
<script src="../js/CargarChats.js"></script>
<script src="../js/CargarMensajes.js"></script>
<script src="../js/CargarInfoProductoMensajes.js"></script>
<script src="../js/EnviarMensaje.js"></script>
<script src="../js/EnviarCotizacion.js"></script>
<script src="../js/CargarCotizacion.js"></script>
