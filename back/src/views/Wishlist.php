...
<h2>Listas de Deseos</h2>
      ...
      <div id="add-wishlist-dialog" class="hidden">
        ...
        <button id="add-wishlist-btn" onclick="CrearWishlist()" >Agregar</button>

        <div>
          <label for="new-wishlist-des">Descripción:</label>
          <input  id= "list-desc" type="text">
        </div>
      </div> 
  ...
  <div id="wishlist">
      ...
      <div class = "lista-container">
          <?php include '../controllers/TraerWishlistsPerfil.php'; ?>
...
<script src="/PureGlow/back/src/js/whislist.js"></script>
